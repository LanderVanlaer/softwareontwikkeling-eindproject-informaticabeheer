...
public class HeroTest {
    ...
    public void getClosestPrimeNumber0() {
        assertEquals(7, Hero.getClosestPrimeNumber(10));
    }

    @Test
    public void getClosestPrimeNumber1() {
        assertEquals(1, Hero.getClosestPrimeNumber(1));
    }

    @Test
    public void getClosestPrimeNumber2() {
        assertEquals(83, Hero.getClosestPrimeNumber(88));
    }

    @Test
    public void getClosestPrimeNumber3() {
        assertEquals(73, Hero.getClosestPrimeNumber(73));
    }
    ...
    public void hit0() {
        ...
        hero100.hit(hero);
        assertEquals(100 - ((Hero.STRENGTH_AVARAGE - 10) / 2), hero.getHitpoints(), .1);
    }
    ...
    public void hit1() {
        ...
        hero100.hit(hero);
        assertEquals(Hero.getClosestPrimeNumber((int) (100 - ((Hero.STRENGTH_AVARAGE - 10) / 2))), hero.getHitpoints(), .1);
    }
    ...
    public void multiplyStrength() {
        ...
        assertEquals(Hero.STRENGTH_AVARAGE * 2D, hero100.getStrength(), .01);
    }
